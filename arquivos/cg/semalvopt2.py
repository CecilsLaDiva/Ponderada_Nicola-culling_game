...
class MazeSemalvopt2(Node):
    def __init__(self):
        super().__init__('maze_semalvopt2')
    ...
    def run(self):
        self.get_logger().info('Iniciando Exploração/mapeamento de área (Sem info do alvo)...')
        res = self.reset_game()
...
def main(args=None):
    ...
    semalvopt2 = MazeSemalvopt2()
    semalvopt2.run()
    semalvopt2.destroy_node()
    rclpy.shutdown()
